...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        ghostPosition = None
        for pos1 in livingGhostPositionDistributions:
            #Your agent should first find the most likely position of each remaining uncaptured
            #ghost, then choose an action that minimizes the maze distance to the closest ghost.
            #To find the maze distance between any two positions pos1 and pos2, use:
            dist = self.distancer.getDistance(pos1.argMax(), pacmanPosition)
            if dist < ghostDistance:
                ghost_distance = dist
                ghostPosition = pos1.argMax()
        ...
        for action in legal:
            ...
            dist = self.distancer.getDistance(ghostPosition, successorPosition)
